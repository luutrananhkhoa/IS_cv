...
contract ListBusiness {
    ...
    function getListDN(address _businessOwner) public view returns(address[] memory, string[] memory, string[] memory, string[] memory, string[] memory, string[] memory, string[] memory) {
