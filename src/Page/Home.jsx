      ...
      <div className="min-h-screen min-w-full overflow-hidden">
        <div className="h-screen min-h-full bg-primary py-[6rem] flex justify-between px-[174px]">
          <div className="w-6/12">
            ...
            <Link to="/login"><button className="w-[10rem] h-12 text-[1.2rem] font-medium mt-8 bg-secondary text-white hover:cursor-pointer"
              onClick={createCv}>Create My CV</button></Link>
