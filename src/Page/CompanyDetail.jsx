...
export default function CompanyDetail() {
  ...
  return (
    <>
        ...
        {openModal && <ModalSuccess open={openModal} title="applied" setOpen={setOpenModal}/>}
        {statusBtn && <ModalWarning statusBtn={statusBtn} setStatusBtn={setStatusBtn}/>}
        {/* <ModalSuccess open={openModal} title="applied" setOpen={setOpenModal}/> */}
            <div className="w-[65%] h-[70%] mx-auto p-[2.5rem] mt-10 bg-white rounded-[1rem]">
                <div className="flex">
                ...
                {posts[0]?.map((item,index)=>(
                    ...
                    <div key={item} className="w-full h-[10rem] mt-6 p-6 bg-[#E7E7E7] rounded-md">
                        ...
                        <div className="flex justify-between">
                            ...
                            <button className=" w-[6rem] h-[2.5rem] mt-8  text-[1rem] text-white font-semibd text-center bg-orange-btn hover:bg-secondary rounded-[2rem]"
